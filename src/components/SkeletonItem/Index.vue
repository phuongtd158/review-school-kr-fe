<template>
  <div class="flex items-start gap-4 p-4 animate-pulse bg-white border-b border-gray-200">
    <!-- Logo -->
    <div class="w-16 h-16 bg-gray-200 rounded object-contain shrink-0"></div>
    <!-- Nội dung -->
